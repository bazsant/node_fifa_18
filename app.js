...
app.use('/javascripts', express.static(__dirname + '/node_modules/tether/dist/js')); // redirect tether JS
...
app.use('/stylesheets', express.static(__dirname + '/node_modules/tether/dist/css')); // redirect CSS tether
